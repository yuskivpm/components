...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  __name: "DatahubDataTypeStockValueConfiguration",
        ...
        _createVNode(_unref(ACol), null, {
          default: _withCtx(() => [
            _createVNode(_unref(ATextField), {
              ...
              label: _unref(t)("datahub-plugin.stockValue.precision"),
              type: "number",
        ...
        _createVNode(_unref(ACol), null, {
          default: _withCtx(() => [
            _createVNode(_unref(ACheckbox), {
              ...
              label: _unref(t)("datahub-plugin.stockValue.readOnly"),
              readonly: _ctx.readonly
            }, null, 8, ["modelValue", "label", "readonly"])
          ]),
          _: 1
...
//# sourceMappingURL=DatahubDataTypeStockValueConfiguration.mjs.map
