...
import _sfc_main$d from "./DatahubDataTypeIntegerValueConfiguration.mjs";
import _sfc_main$e from "./DatahubDataTypeSimplePricingValueConfiguration.mjs";
import _sfc_main$f from "./DatahubDataTypeStockValueConfiguration.mjs";
import _sfc_main$g from "./DatahubDataTypeStringValueConfiguration.mjs";
import _sfc_main$h from "./DatahubDataTypeTextFieldConfiguration.mjs";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.mjs";
import _sfc_main$i from "./DatahubDataTypeUnitValueConfiguration.mjs";
import _sfc_main$j from "./DatahubDataTypeImageValueConfiguration.mjs";
import _sfc_main$k from "./DatahubDataTypeFileValueConfiguration.mjs";
import _sfc_main$l from "./DatahubDataTypeOfferRelationValueConfiguration.mjs";
...
import _sfc_main$p from "./DatahubDataTypeIntegerValueEditor.mjs";
...
const _sfc_main$7 = /* @__PURE__ */ _defineComponent$7({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const tableProps = computed$3(() => ({
      tableName: props.title ? t(props.title) : t("attributeGroups.levelN", { level: props.level ?? 1 }),
        ...
        _createVNode(_unref$2(ACol), null, {
          default: _withCtx(() => [
            _createVNode(_unref$2(ACheckbox), {
              ...
              label: _unref$2(t)("datahub-plugin.stringValue.readOnly"),
        ...
        _createVNode(_unref$2(ACol), null, {
          default: _withCtx(() => [
            _createVNode(_unref$2(ACheckbox), {
              ...
              label: _unref$2(t)("datahub-plugin.treeView.multiSelect"),
              readonly: _ctx.readonly
            }, null, 8, ["modelValue", "label", "readonly"])
          ]),
          _: 1
        ...
        _createVNode(_unref$2(ACol), null, {
          default: _withCtx(() => [
            _createVNode(_unref$2(ACheckbox), {
              ...
              label: _unref$2(t)("datahub-plugin.treeView.flat"),
              readonly: _ctx.readonly
            }, null, 8, ["modelValue", "label", "readonly"])
          ]),
          _: 1
      ...
      "en": {
        "datahub-plugin": {
          "treeView": {
            ...
            "multiSelect": (ctx) => {
              const { normalize: _normalize } = ctx;
              return _normalize(["Multi select"]);
            },
            "readOnly": (ctx) => {
              const { normalize: _normalize } = ctx;
      ...
      "de": {
        "datahub-plugin": {
          "treeView": {
            "flat": (ctx) => {
              const { normalize: _normalize } = ctx;
              return _normalize(["Flach"]);
            },
            "multiSelect": (ctx) => {
              const { normalize: _normalize } = ctx;
              return _normalize(["Mehrfachauswahl"]);
            },
            "readOnly": (ctx) => {
              const { normalize: _normalize } = ctx;
...
//# sourceMappingURL=DatahubExternalComponent.vue_vue_type_script_setup_true_lang-DamvDhDc.mjs.map
