...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  __name: "DatahubDataTypeConfigurationUnitValue",
  props: _mergeModels({
    dataTypeInstance: {},
    remoteScopes: {},
    remoteLanguages: {},
        ...
        _createVNode(_unref(ACol), null, {
          default: _withCtx(() => [
            _createVNode(_unref(ASelect), {
              ...
              label: _ctx.$t("unitValue.dimension"),
        ...
        _createVNode(_unref(ACol), null, {
          default: _withCtx(() => [
            _createVNode(_unref(ASelect), {
              ...
              label: _ctx.$t("unitValue.defaultUnit"),
              readonly: _ctx.readonly,
              "item-value": "id"
...
//# sourceMappingURL=DatahubDataTypeConfigurationUnitValue.mjs.map
