import { _ as _sfc_main$1 } from "./DatahubBadWordFilter.vue_vue_type_script_setup_true_lang-784cd056.mjs";
...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const configuration = useModel(props, "modelValue");
    onMounted(() => {
    ...
    return (_ctx, _cache) => {
      return _openBlock(), _createBlock(_unref(AContainer), null, {
        default: _withCtx(() => [
          _unref(configuration) ? (_openBlock(), _createBlock(_unref(ARow), { key: 0 }, {
            default: _withCtx(() => [
              _createVNode(_unref(ACol), null, {
                default: _withCtx(() => [
                  _createVNode(_unref(ATextField), {
                    modelValue: _unref(configuration).min,
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _unref(configuration).min = $event),
              ...
              _createVNode(_unref(ACol), null, {
                default: _withCtx(() => [
                  _createVNode(_unref(ATextField), {
                    modelValue: _unref(configuration).max,
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _unref(configuration).max = $event),
              ...
              _createVNode(_unref(ACol), null, {
                default: _withCtx(() => [
                  _createVNode(_unref(ATextField), {
                    modelValue: _unref(configuration).regex,
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => _unref(configuration).regex = $event),
              ...
              _createVNode(_unref(ACol), null, {
                default: _withCtx(() => [
                  _createVNode(_unref(ACheckbox), {
                    modelValue: _unref(configuration).readOnly,
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => _unref(configuration).readOnly = $event),
              ...
              _createVNode(_sfc_main$1, {
                modelValue: _unref(configuration).badwords,
                "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => _unref(configuration).badwords = $event),
